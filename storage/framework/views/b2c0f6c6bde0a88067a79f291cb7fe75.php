...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="row mb-3">
                <label for="url" class="col-md-4 col-form-label text-md-end"><?php echo e(__('URL')); ?></label>
                <div class="col-md-6">
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="row mb-3">
                <label for="profile_image" class="col-md-4 col-form-label text-md-end"><?php echo e(__('Profile Picture')); ?></label>
                <div class="col-md-6">
...
unset($__errorArgs, $__bag); ?>" name="profile_image" value="<?php echo e(old('profile_image')); ?>" autocomplete="profile_image" autofocus>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\instagram-clone\resources\views/profiles/edit.blade.php ENDPATH**/ ?>